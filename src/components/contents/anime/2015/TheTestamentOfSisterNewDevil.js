            ...
            <section id="gallery" className="gallery section">
                <div className="container-fluid" data-aos="fade-up" data-aos-delay="200">
                    <div className="row gy-4 justify-content-center">
                        ...
                        <div className="col-xl-3 col-lg-4 col-md-6">
                            <div className="gallery-item h-100">
                                <img src="img/anime/2015/the-testament-of-sister-new-devil/NaruseMio.webp" className="img-fluid" alt="Naruse Mio" />
                                <div className="gallery-links d-flex align-items-center justify-content-center">
                                    <div className="card-img-overlay d-flex align-items-center p-0">
                                        <h5 className="card-title text-center flex-fill p-3 fs-4 waifu-overlay">
                                            <small>Naruse Mio</small>
                                            <br />
                                            <a href="img/anime/2015/the-testament-of-sister-new-devil/NaruseMio.webp" className="glightbox preview-link">(The Testament Of Sister)</a>
                                        </h5>
                                    </div>
                                </div>
                            </div>
