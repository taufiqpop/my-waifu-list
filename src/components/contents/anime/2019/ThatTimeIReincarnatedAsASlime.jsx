...
const ThatTimeIReincarnatedAsASlime = () => {
    useEffect(() => {
        GLightbox({
            selector: '.glightbox',
        });
                ...
                <div className="container">
                    <div className="row justify-content-center">
                        <div className="col-lg-6 text-center" data-aos="fade-up" data-aos-delay="50">
                            ...
                            <a href='https://www.livechart.me/anime/3132' target="_blank" rel="noreferrer" className="btn-get-started my-rating">My Rating ⭐ 10/10<br /></a>
                        </div>
                    </div>
                </div>
            </section>
...
export default ThatTimeIReincarnatedAsASlime;
